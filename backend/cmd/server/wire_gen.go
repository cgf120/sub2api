...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	grokBudgetCache := repository.NewGrokBudgetCache(redisClient)
	grokGatewayService := service.NewGrokGatewayService(accountRepository, concurrencyService, grokBudgetCache, configConfig)
	accountTestService := service.NewAccountTestService(accountRepository, geminiTokenProvider, claudeTokenProvider, antigravityGatewayService, grokGatewayService, httpUpstream, configConfig, tlsFingerprintProfileService)
	...
	grokGatewayHandler := handler.NewGrokGatewayHandler(grokGatewayService, openAIGatewayService, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, contentModerationService, configConfig)

<template>
  <AppLayout>
    ...
    <AccountBulkImportModal :show="showBulkImport" :proxies="proxies" :groups="groups" @close="showBulkImport = false" @imported="reload" />

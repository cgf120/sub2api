...
const BADGE: Record<Platform, string> = {
  ...
  grok: 'bg-rose-500/10 text-rose-600 border-rose-500/30 dark:text-rose-400',
}
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  grok: 'bg-rose-500/10 text-rose-600 dark:bg-rose-500/10 dark:text-rose-300',
}
...
const BORDER: Record<Platform, string> = {
  ...
  grok: 'border-rose-500/20 dark:border-rose-500/20',
}
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  grok: 'bg-gradient-to-r from-rose-400 to-rose-500',
}
...
const ICON: Record<Platform, string> = {
  ...
  grok: 'text-rose-500 dark:text-rose-400',
}
...
const BUTTON: Record<Platform, string> = {
  ...
  grok: 'bg-rose-500 text-white hover:bg-rose-600 active:bg-rose-700 dark:bg-rose-500/80 dark:hover:bg-rose-500',
}
...
const DISCOUNT: Record<Platform, string> = {
  ...
  grok: 'bg-rose-100 text-rose-700 dark:bg-rose-900/40 dark:text-rose-300',
}
...
const GRADIENT: Record<Platform, string> = {
  ...
  grok: 'from-rose-500 to-rose-600',
}

...
defineProps<{ selectedIds: number[]; testing?: boolean }>()
defineEmits(['delete', 'edit-selected', 'edit-filtered', 'clear', 'select-page', 'toggle-schedulable', 'reset-status', 'refresh-token', 'test-selected'])
const { t } = useI18n()
</script>
